...
class LandlordPropertyUnitInfoDetails extends StatefulWidget {
  ...
  @override
  LandlordPropertyUnitInfoDetailsState createState() =>
      LandlordPropertyUnitInfoDetailsState();
}

class LandlordPropertyUnitInfoDetailsState
    ...
    return Directionality(
        ...
        child: Scaffold(
          ...
          body: SingleChildScrollView(child: Obx(() {
            return Column(
              children: [
                CustomAppBar2(title: AppMetaLabels().unitDetail),
                SizedBox(
