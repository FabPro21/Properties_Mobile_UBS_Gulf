...
import 'package:fap_properties/views/tenant/tenant_contracts/tenant_contracts_tabs.dart/tenant_contracts_details.dart/authenticate_contract/authenticate_contract_controller.dart';
...
class AuthenticateContract extends StatefulWidget {
  ...
  @override
  _AuthenticateContractState createState() => _AuthenticateContractState();
}

class _AuthenticateContractState extends State<AuthenticateContract> {
  final controller = Get.put(AuthenticateContractController());
