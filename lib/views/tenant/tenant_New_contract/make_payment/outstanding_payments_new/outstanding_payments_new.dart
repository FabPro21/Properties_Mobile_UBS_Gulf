...
import 'package:fap_properties/views/tenant/tenant_New_contract/make_payment/online_payments_new/online_payments_new.dart';
...
import 'outstanding_payments_new_controller.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/services.dart';
import 'dart:ui' as ui;

class OutstandingPaymentsNewContract extends StatefulWidget {
...
class _OutstandingPaymentsNewContractState
  ...
  //  Cheque Upload and Downliad while payment
  @override
...
//                       ? payable.title //+' Index: '+ index1.toString() ?? ''
//                       : payable.titleAr ?? '',
//                   style: AppTextStyle.normalBlack10,
//                 ),
//               ),
...
//                                               //         .record![index1].confirmed ==
//                                               //     0) {
//                                               payable.paymentMethodId.value = 1;
//                                               payable.filePath = null;
//                                               setState(() {
//                                                 isEnableScreen = false;
//                                               });
...
//                                                     .record![index1].confirmed ==
//                                                 0) {
//                                               payable.paymentMethodId.value = 2;
//                                               payable.filePath = null;
//                                               setState(() {
//                                                 isEnableScreen = false;
//                                               });
...
//           Obx(() {
//             return payable.paymentMethodId.value == 2 &&
//                     !payable.updatingPaymentMethod.value &&
//                     !payable.errorUpdatingPaymentMethod
//                 ? Padding(
//                     padding: EdgeInsets.only(bottom: 1.h),
