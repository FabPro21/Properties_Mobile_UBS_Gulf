...
class OutstandingPaymentsNewContractController extends GetxController {
  ...
  Future<int> getOutstandingPayments() async {
    ...
    try {
      ...
      // var resp = await TenantRepository.getOutstandingPaymentsNewContract(
      //     SessionController().getContractID());
  ...
  updatePaymentMethod(
    ...
    // final response = await TenantRepository.updatePaymentMethodNew(payable);
