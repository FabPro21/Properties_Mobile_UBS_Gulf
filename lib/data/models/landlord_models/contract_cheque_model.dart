...
GetContractChequesModelLandlord getContractChequesModelFromJson(String? str) =>
    GetContractChequesModelLandlord.fromJson(json.decode(str!));

String? getContractChequesModelToJson(GetContractChequesModelLandlord data) =>
    json.encode(data.toJson());

class GetContractChequesModelLandlord {
  GetContractChequesModelLandlord({
    this.status,
    this.statusCode,
  ...
  factory GetContractChequesModelLandlord.fromJson(Map<String?, dynamic> json) =>
      GetContractChequesModelLandlord(
        status: json["status"],
