...
#ifndef APPLE_MAPS_FLUTTER_SWIFT_H
#define APPLE_MAPS_FLUTTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="apple_maps_flutter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18apple_maps_flutter18AppleMapController")
@interface AppleMapController : NSObject <FlutterPlatformView>
...
@interface AppleMapController (SWIFT_EXTENSION(apple_maps_flutter)) <MKMapViewDelegate>
...
@interface AppleMapController (SWIFT_EXTENSION(apple_maps_flutter))
...
SWIFT_CLASS("_TtC18apple_maps_flutter19AppleMapViewFactory")
@interface AppleMapViewFactory : NSObject <FlutterPlatformViewFactory>
...
SWIFT_CLASS("_TtC18apple_maps_flutter27SwiftAppleMapsFlutterPlugin")
@interface SwiftAppleMapsFlutterPlugin : NSObject <FlutterPlugin>
